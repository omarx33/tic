...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <center><b>INFORME DIAS DE APOYO  <?php echo $periodo ?> </b></center>
      </div>
      <div class="col-md-4">
    ...
    <table>
      ...
      <tr>
        ...
        <td style="border: 0;">Informe de días de apoyo </td>
      </tr>
    </table>
    <br>

    <p>Por medio del presente me dirijo a Ud. Para saludarlo muy cordialmente  a la vez informarle los días  de apoyo.</p>

    <center><b>_______________________________________________________________________________________</b></center>
    <br><br>
    <style media="screen">
    table {
       width: 100%;
    ...
    <table class="tabla">
      <thead>
        <tr>
          ...
          <th style=" text-align: center;"><b># Dias</b> </th>
      ...
      <tbody>
        <?php $item=1; foreach ($info as $key): ?>
          <tr>
            ...
            <td><center><?php echo $key->dias ?></center></td>
